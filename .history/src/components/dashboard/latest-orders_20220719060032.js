...
const LatestOrders = (props) => {
  return (
    <>
      <div style={{ height: 400, width: "100%", background: 'grey[100[' }}>
        <Box
          sx={{
            height: 400,
            width: "100%",
            "& .super-app-theme--Open": {
              bgcolor: (theme) =>
                getBackgroundColor(theme.palette.info.main, theme.palette.error.main),
              "&:hover": {
                bgcolor: (theme) =>
                  getHoverBackgroundColor(theme.palette.info.main, theme.palette.error.main),
              },
            },
            "& .super-app-theme--Filled": {
              ...
              "&:hover": {
                bgcolor: (theme) =>
                  getHoverBackgroundColor(theme.palette.success.main, theme.palette.warning.main),
              },
            },
