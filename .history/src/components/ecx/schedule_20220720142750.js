  ...
  return (
    <React.Fragment>
      ...
      <Grid container spacing={3}>
        <Grid item xs={12}>
          <DateTextField selectedDate={fromSelected} handleDateChange={handleFromSelected} label="From" />
        </Grid>
        <Grid item xs={12}>
          <DateTextField selectedDate={toSelected} handleDateChange={handleToSelected} label= />
        </Grid>
