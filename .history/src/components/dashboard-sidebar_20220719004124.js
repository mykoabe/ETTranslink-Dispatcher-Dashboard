...
const items = [
  ...
  {
    text: "Manage Facilitators",
    icon: <UserIcon fontSize="small" />,
    href: "/facilitators",
  },
  {
    text: "Loads",
    icon: <ShippingBagIcon fontSize="small" />,
    href: "/new-load",
  },

  {
    text: "App request load",
  ...
  {
    text: "Moving Truckers",
    icon: <ShippingBagIcon fontSize="small" />,
    href: "/moving-truckers",
  },
  {
    text: "Accept Compliants",
    icon: <ShippingBag fontSize="small" />,
    href: "/compliants",
  },
];
