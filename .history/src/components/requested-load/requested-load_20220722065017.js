...
const orders = [
  ...
  createData('Delivery information2', 'All Delivery information here 2', 'All Loading/Unloading Date will be here', 'All Load from to information will be here', 'Customer information'),
  createData('Delivery information3', 'All Delivery information will be here', 'All Loading/Unloading Date will be here', 'All Load from to information will be here', 'Customer information'),
  createData('Delivery information4', 'All Delivery information will be here', 'All Loading/Unloading Date will be here', 'All Load from to information will be here', 'Customer information'),
];
