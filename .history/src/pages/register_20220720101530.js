...
const dispatcherValues = [
  {
    value: "normal-dispatcher",
    label: "Normal Dispatcher",
  },
  {
    value: "ecx-dispatcher",
    label: "ECX Dispatcher",
  },
  {
...
export default function Register() {
  ...
  const [role, setDispatcher] = useState("");
  ...
  const hanldleDispatcherChange = (event) => {
  ...
  handleInputChange = (event) => {
    ...
    setData({ ...data, dispatcher, [id]: value });
  }
