...
const ECXLoadStatus = dynamic(() => import("../components/dashboard/ecx-load-status"));
...
const LoadListProgressInfo = dynamic(() => import("../components/dashboard/load-list-progress-info"));
